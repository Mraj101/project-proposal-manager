                  ...
                  <tr key={proposal._id}>
                    ...
                    <td colSpan={proposal.isAccepted ? "2" : "1"}>
                      ...
                      proposal.isAccepetedByHOD === false ? (
                        <span className="px-1 py-1 rounded-lg bg-blue-400 text-white">
                          Sent to HOD
                        </span>
                      ) : proposal.isAccepted === true &&
                        proposal.isAccepetedByHOD === true ? (
                        <span className="px-1 py-1 rounded-lg bg-green-400 text-white">
                          ApprovedByHod
                        </span>
                      ) : proposal.isRejected ||
                        proposal.isRejectedByHOD === true ? (
                        <span className="px-1 py-1 rounded-lg bg-red-400 text-white">
                          Rejected
                        </span>
                      ) : (
